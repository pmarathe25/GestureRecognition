...
def main():
    global status_text, register_text
...
def process_gesture():
    global output_file, gesture, register_text, status_text
    ...
    save_gesture(output_file, gesture_deltas[0:index], register_text.get())

def save_gesture(filename, gesture_deltas, gesture_name):
    pass
